...
# Wanted to make it pretty and neat
# Foudn this line online to query the datapase to get the terms for ease
set allPins [dbget top.terms.name]
set totalPins [llength $allPins]
set topPins [lrange $allPins 0 [expr {int($totalPins/2) - 1}]]
set bottomPins [lrange $allPins [expr {int($totalPins/2)}] end]
